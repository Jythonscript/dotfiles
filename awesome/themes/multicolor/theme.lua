...
theme.mpd = lain.widget.mpd({
    settings = function()
		local songnumber = os.capture("sh ~/Documents/shell/songnumber.sh")
		local totalsongs = os.capture("sh ~/Documents/shell/totalsongs.sh")
        ...
        if mpd_now.state == "play" then
            ...
            title  = mpd_now.title .. " [" .. songnumber .. "/" .. totalsongs .. "]" .. " "
